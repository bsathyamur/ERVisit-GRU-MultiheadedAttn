...
def collate_fn(data):
    ...
    Outputs:
        x: a tensor of shape (# patients, max # of claims, max # diagnosis codes) of type torch.long
        masks: a tensor of shape (# patiens, max # of claims, max # diagnosis codes) of type torch.bool
    ...
    maxNumOfVisits = config['max_claims']
